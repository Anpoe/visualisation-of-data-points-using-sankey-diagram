...
def draw_connected_line(draw, border_size, cal_pixels, n, pos, pos_upper, pos_x1):
    ...
    for i in range(400):
        draw_connected_color(draw, n, c1, c2, c3)
        draw.drawLine(border_size + x1, 550 - y, border_size + cal_pixels + x2, 550 - y)
        x2 += X2
        x1 += X1
        y += 1
        c1, c2, c3 = draw_connected_color(draw, n, c1, c2, c3)
    return

def draw_connected_color(draw, n, c1, c2, c3):

    if n[0] - c1 > 0:
        draw.setColor(n[0] - c1, n[1] - c2, n[2] - c3)
        c1 += 1 
        return c1, c2, c3
    elif n[0] - c1 == 0:
        draw.setColor(0, n[1], n[2])

    if n[1] - c2 > 0:
        draw.setColor(0, n[1] - c2, n[2])
        c2 += 1 
        return c1, c2, c3
    elif n[1] - c2 == 0:
        draw.setColor(0, 0, n[2])

    if n[2] - c3 > 0:
        draw.setColor(0, 0, n[2] - c3)
        c3 += 1 
        return c1, c2, c3
    elif n[2] - c3 == 0:
        draw.setColor(0, 0, 0)
